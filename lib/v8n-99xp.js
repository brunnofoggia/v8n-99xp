...
(function (global, factory) {
    typeof exports === 'object' && typeof module !== 'undefined' ? factory(exports, require('v8n'), require('underscore-99xp')) :
    typeof define === 'function' && define.amd ? define(['exports', 'v8n', 'underscore-99xp'], factory) :
      ...
      fullname(expected) {
        return value => {
          var validate = function (v) {
            ...
            if (/^[a-zA-Z]{2,}(\s+(([a-zA-Z]{2,})))+$/.test(vf)) {
              return true;
            }
